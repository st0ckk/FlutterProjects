...
class UserCreateWidget extends StatefulWidget {
  ...
  static String routeName = 'userCreate';
  static String routePath = '/userCreate';
...
class _UserCreateWidgetState extends State<UserCreateWidget> {
  ...
  void initState() {
    ...
    _model.nombreFieldTextController ??= TextEditingController();
    ...
    _model.passwordField2TextController ??= TextEditingController();
                  ...
                  children: [
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              TextFormField(
                                controller: _model.nombreFieldTextController,
                                ...
                                validator: _model
                                    .nombreFieldTextControllerValidator
                                    .asValidator(context),
                                inputFormatters: [
                                  if (!isAndroid && !isiOS)
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              TextFormField(
                                controller: _model.correoFieldTextController,
                                focusNode: _model.correoFieldFocusNode,
                                autofocus: false,
                                ...
                                cursorColor: Color(0xFF8B4A6B),
                                validator: _model
                                    .correoFieldTextControllerValidator
                                    .asValidator(context),
                                inputFormatters: [
                                  if (!isAndroid && !isiOS)
                                    TextInputFormatter.withFunction(
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              TextFormField(
                                controller: _model.passwordField2TextController,
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(
                          colors: [Color(0xFFDD7FAA), Color(0xFFC45E8E)],
                          stops: [0.0, 1.0],
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          if (_model.passwordFieldTextController.text !=
                              _model.passwordField2TextController.text) {
                          ...
                          final user = await authManager.createAccountWithEmail(
                            context,
                            _model.correoFieldTextController.text,
